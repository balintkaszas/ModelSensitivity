...
ftleField = FTLE(duff, init, timeSpan, true, 1e-7, 'finitedifference');
...
colormap(jet)
FF = repmat(ftleField,1,1,3);
FF=smooth3(FF,'gaussian',3);
ftle1 = FF(:,:,1);
surf(xs,ys,ftle1);shading interp; axis equal;axis tight;colorbar; xlabel('x'); ylabel('y')
