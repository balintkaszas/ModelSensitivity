function [t,uncertAtTime] = computeAlongTrajectorySq(derivative, initialPoint, timeInterval, stepSize )
...
for i=1:n
    ...
    % 1 point
    temp = uncertEstimateSq(derivative, initialPoint, [1,1], iv, stepSize);
    %disp([iv, temp]);
