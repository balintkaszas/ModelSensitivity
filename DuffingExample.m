%% Define the system
dyref = @(t,x) d_duffing(t,x,0, false); %% specify derivative for the duffing system
...
ms1 = FF(:,:,1);
surf(xs,ys,ms1);shading interp; axis equal;axis tight;colorbar; xlabel('x'); ylabel('y')
