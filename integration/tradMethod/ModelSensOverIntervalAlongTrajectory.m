function [t,uncertAtTime] = ModelSensOverIntervalAlongTrajectory(derivative, initialPoint, timeInterval, stepSize )
...
for i=1:n
    ...
    % 1 point
    temp = ModelSensOverInterval(derivative, initialPoint, [1,1], iv, stepSize);
    %disp([iv, temp]);
