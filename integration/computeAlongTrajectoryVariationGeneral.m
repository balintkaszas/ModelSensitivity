function [t,uncertAtTime] = computeAlongTrajectoryVariationGeneral(derivative, initialPoint, timeInterval, stepSize )
...
for i=1:n
    ...
    % 1 point
    temp = uncertEstimateVariationalNonvectorized(derivative, initialPoint,[1,1], iv, stepSize);
    %disp([iv, temp]);
